...
public class Attack implements Serializable {
	...
	public Attack(String name, String type, int bonus, Dice damage) {
		super();
		this.name = name;
		this.type = type;
		this.bonus = bonus;
	...
	public Attack(int attack_id, String name, String type, int bonus, Dice damage) {
		super();
	...
	public String toString() {
		return "Attack [attack_id=" + attack_id + ", name=" + name + ", type=" + type + ", bonus=" + bonus + ", damage="
				+ damage + "]";
	}
